...
# response = supabase.table("security_system").delete().eq("id", "person3").execute()
# print(response.data)

# Insert test legitimate customer
response = supabase.table("security_system").insert({"id": "person3", "location": "entrance/exit"}).execute()
response = supabase.table("security_system").insert({"id": "person3", "location": "checkout"}).execute()
response = supabase.table("security_system").insert({"id": "person3", "location": "entrance/exit"}).execute()
